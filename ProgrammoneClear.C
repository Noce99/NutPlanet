...
void createFinestraSimulatore(bool ss){
	...
	builder = gtk_builder_new ();
  	if (gtk_builder_add_from_file (builder, "BuilderComandi.ui", &error) == 0){
	...
	builder = gtk_builder_new ();
  	if (gtk_builder_add_from_file (builder, "BuilderSettings.ui", &error) == 0){
      g_printerr ("Error loading file: %s\n", error->message);
      g_clear_error (&error);
    }
	...
	builder = gtk_builder_new ();
  	if (gtk_builder_add_from_file (builder, "BuilderInfoU.ui", &error) == 0){
      g_printerr ("Error loading file: %s\n", error->message);
      g_clear_error (&error);
    }
	...
	builder = gtk_builder_new ();
  	if (gtk_builder_add_from_file (builder, "BuilderInfoP.ui", &error) == 0){
      g_printerr ("Error loading file: %s\n", error->message);
      g_clear_error (&error);
    }
	...
	builder = gtk_builder_new ();
  	if (gtk_builder_add_from_file (builder, "BuilderAddP.ui", &error) == 0){
      g_printerr ("Error loading file: %s\n", error->message);
      g_clear_error (&error);
    }
